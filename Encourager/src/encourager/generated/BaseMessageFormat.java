...
//	if (null == o) return "null";
	...
	protected javax.xml.validation.Schema schema = null;
	...
	protected boolean Init(Class rc) {
		...
		filenamexsd = "xsd"+File.separatorChar+sn+".xsd";
	...
	public Object Unmarshal(String xmldata) throws JAXBException {
		...
		JAXBElement o=null;
		try {
		tmpo = u.unmarshal(xmlReader);
		} catch (JAXBException e) {
		e.printStackTrace();return null;
		}
		try {
		o = (JAXBElement)tmpo;
		} catch (ClassCastException e) {return tmpo;}
...
//	ALBANO: is this faster?	Object o = u.unmarshal( new StreamSource( new StringReader( xmlStr.toString() ) ) );
	...
	public String Marshal(Object mr) {
		...
		catch (PropertyException e) {e.printStackTrace();return null;}
